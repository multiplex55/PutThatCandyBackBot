...
@bot.command(name='reddit', help='random reddit image')
...
@bot.command(name='vote', help='random reddit image')
async def do_call_vote(ctx):
    ...
    vote_string = ctx.message.content[10:]
    VOTE_LENGTH = 17
...
async def cmd_help(ctx):
    ...
    embed.add_field(name="crabrave",value="Crabrave video", inline=False)
    embed.add_field(name="brothermanbill",value="brothermanbill video", inline=False)
    embed.add_field(name="oceanman",value="oceanman video", inline=False)
